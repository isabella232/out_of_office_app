...
AWS.config.update({accessKeyId: 'AKIAJR5E63XD6GXEWHKA', secretAccessKey: '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'}); //I should mention that these credentials *only* have Lambda execute permissions, nothing else (and so should be safe to expose)
